		...
		<div class="basic-container">
			...
			<div data-role="popup" id="popupDialog" data-overlay-theme="a"
				...
				<div role="main" class="ui-content">
					<h3 class="ui-title">매일학습을 종료하시겠습니까?</h3>
					<a href="#"
						class="ui-btn ui-corner-all ui-shadow ui-btn-a" data-rel="back"> 취소 </a> 
					<a href="/01DiaWeb/conList.do"
						class="ui-btn ui-corner-all ui-shadow ui-btn-a" data-transition="flip">종료</a>
				</div>
			</div>
